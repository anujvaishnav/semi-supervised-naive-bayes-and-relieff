function [predictedLabel accuracy] = NBTest(parameters, testAttributeSet, validLabel)
...
%       likelihood = 1 / size(parameters,1);
      ...
      for feature = 1:size(testAttributeSet,2)
        ...
        possibleAttributes = parameters{class,1}{feature,1}{1,1};
        allProbs = parameters{class,1}{feature,1}{1,2};      
